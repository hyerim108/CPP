...
/*   Updated: 2023/07/26 14:23:03 by hyerimki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string const name, int grade, int certain_grade) : name(name), grade(grade), certain_grade(certain_grade)
{
...
Form::Form(const Form &form) : name(form.name), grade(form.grade), certain_grade(form.certain_grade)
{
...
int Form::getCertainGrade(void) const
{
...
std::ostream &operator<<(std::ostream &o, const Form &form)
{
    ...
    o << "<Form CretainGrade> : " << form.getCertainGrade() << std::endl;
